    ...
    <div id="body">            
        <form action="javascript: fn_buscar();" id="frm_buscar" name="frm_buscar">
            <fieldset>       
                ...
                <h1>Consulta de Ingresos por Comensal</h1>                                
                ...
                <br/>
                <cite>Ubicación Mesa:</cite> 
                <select name="ubicacion" ide="ubicacion" class="required">     
                    <option value="">Todas</option>                        
                    <?php
                        $conexion = new ConsultaBD();
                        $conexion->Conectar();
                        $sql = "select * from ubicacion order by descripcion";
                ...
                <cite>Gasto x mesa desde</cite>                 
                <input type="text" name="gastado_de" id="gastado_de" size="10"/>       
                <cite>hasta</cite>                 
                <input type="text" name="gastado_hasta" id="gastado_hasta"  size="10"/>                       
                <br/>
                <cite>Ordenar por:</cite>  
                <select name="criterio_ordenar_por" id="criterio_ordenar_por">
                    <option value="fecha_y_hora">Fecha y Hora</option>                                      
