...
$consulta  = "SELECT id,proximo_vencimiento_normal,dias_a_vencer FROM documentacion_vehiculos";
...
//documento por docuemento, tomo el próximo vencimiento y según la fecha actual calculo el plazo a vencer y actualizo los días a vencer en la tabla
    ...
    $sql = "UPDATE documentacion_vehiculos SET dias_a_vencer='$dias_a_vencer' WHERE id=$id";
    mysql_query($sql);
