...
?>
<div align="center"><h1>REGISTRO DE SALIDA</h1></div>
...
<style type="text/css">
    ...
    <script language="JavaScript">
		webcam.set_api_url( 'sube_foto_salida.php' );//PHP adonde va a recibir la imagen y la va a guardar en el servidor
		...
		function my_completion_handler(msg) {
			...
			if (msg.match(/(http\:\/\/\S+)/)) {
				...
				document.getElementById('upload_results').innerHTML = 
					'<img src="' + image_url + '">'+
					'<form action="gestion_foto_salida.php" method="post">'+
					...
					'<label>Empleado </label><select name="empleado_id">'+
                                        ...
                                        ?>
                                        '</select>'+
				    '<br><br><input type="submit" name="button" id="button" value="Confirmar egreso" /></form>'
					;
