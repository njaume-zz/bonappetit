...
$consulta2  = "SELECT * FROM vehiculos ORDER BY descripcion";
...
<div align="center" class="titulo">
    <strong>ALERTA</strong>: Esta planilla NO EDITABLE  permite una vista panor&aacute;mica de los vencimientos de documentaci&oacute;n de vehiculoes.
</div>
...
<?php
    ...
    for ($j=0; $j<=$nro_columnas-1; $j++) { //while que crea el encabezado de la tabla
        ...
        echo '
        <th bgcolor="white">
        <form name="form" method="post" action="alerta_vehiculos.php">
