...
new Scaffold(
        ...
        60,                                                              // Cantidad de registros a mostrar por página   
        ...
        array('total','finalizado'),                                     // Campos a ocultar del maestro en el detalle
        array('','E','B','N')
);
...
while($fila = mysql_fetch_array($consulta, MYSQL_BOTH)){
    ...
    $importe_total = $importe_total + ($cantidad*$importe);
