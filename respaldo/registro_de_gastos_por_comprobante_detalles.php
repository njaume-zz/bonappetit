...
<?php
new Scaffold("editable","registro_de_gastos_por_comprobante_detalles",30);
...
$sql = "SELECT * 
            FROM  `registro_de_gastos_por_comprobante_detalles` 
            WHERE  `registro_de_gastos_por_comprobante_maestro_id` =$maestro_id";
$consulta = mysql_query($sql,$link);

//Tomo el importe total según el maestro_id
$importe_total_maestro = DevuelveValor($maestro_id, 'importe', 'registro_de_gastos_por_comprobante_maestros', 'id');
