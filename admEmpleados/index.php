    ...
    <div id="body">            
        <form action="javascript: fn_buscar();" id="frm_buscar" name="frm_buscar">
            <fieldset>
                ...
                <input type="text" name="criterio_buscar" id="criterio_buscar" placeholder="Empleado a buscar" size="40"/>                
                    <select name="criterio_ordenar_por" id="criterio_ordenar_por">
                        <option value="id">Código</option>
                        <option value="descripcion">Apellido y Nombre</option>
                        <option value="dni">DNI</option>                        
                        <option value="tipo_empleados.descripcion">Tipo Empleado</option>
                    </select>                           
